 ...
 * @author Lemon
 */
public class APIJSONSQLConfig<T> extends apijson.framework.javax.APIJSONSQLConfig<T, Map<String, Object>, List<Object>> {
	...
	//		List<Join<T, Map<String, Object>, List<Object>>> joinList, boolean isProcedure) throws Exception {
